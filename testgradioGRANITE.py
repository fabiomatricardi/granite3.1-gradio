import gradio as gr
# to serve the model with llama.cpp server:
# .\llama-server.exe -m .\model\granite-3.1-2b-instruct-Q5_K_L.gguf -c 8192 -ngl 0 --temp 0.2 --repeat-penalty 1.45
# real CTX is 128k
# alternatives - MoE sparse 1B 400M active :  granite-3.1-1b-a400m-instruct-Q8_0.gguf 
# or the DENSE 2B : granite-3.1-2b-instruct-Q5_K_L.gguf

# ---
# parameters working only with ChatInterface:
# save_history=True, flagging_mode="manual", flagging_options=["Like", "Spam", "Inappropriate", "Other"]

modelname = "bartowski_granite-3.1-2b-instruct-GGUF"
gr.load_chat("http://localhost:8080/v1/", model=modelname, token='note-required').launch()
...
build: 4435 (017cc5f4) with MSVC 19.42.34435.0 for x64
...
llama_model_load_from_file: using device Vulkan0 (NVIDIA GeForce RTX 2060 with Max-Q Design) - 5955 MiB free
